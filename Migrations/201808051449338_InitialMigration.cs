namespace Keyholder.Migrations
{
    ...
    public partial class InitialMigration : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        LevelData = c.String(nullable: false, maxLength: 5000, storeType: "nvarchar"),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Levels", "Author_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Levels", new[] { "Author_Id" });
